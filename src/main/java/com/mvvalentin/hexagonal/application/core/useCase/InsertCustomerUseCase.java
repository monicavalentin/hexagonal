...
public class InsertCustomerUseCase {
    ...
    private final FindAddressByZipCodeOutputPort findAddressByZipCodeOutpitPort;
    private final InsertCustomerOutPutPort insertCustomerOutPutPort;

      //Construtor para injeção de dependências.

    public InsertCustomerUseCase(FindAddressByZipCodeOutputPort findAddressByZipCodeOutpitPort ,
                                 InsertCustomerOutPutPort insertCustomerOutPutPort) {
        this.findAddressByZipCodeOutpitPort = findAddressByZipCodeOutpitPort;
