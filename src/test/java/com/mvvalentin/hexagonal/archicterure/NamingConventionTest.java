...
public class NamingConventionTest {
    ...
    /** Valida a padronização de nomes e pacotes.
     * * OBJETIVO: Garantir que cada componente (Controller, UseCase, Mapper, etc.)
     * esteja no local correto e use o sufixo adequado, evitando que lógica de
     * infraestrutura "vaze" para o Core da aplicação.
     **/
    ...
    /**
     * Padronização de Nomenclatura por Camada.
     * * REGRA: Garante que toda classe dentro deste pacote possua o sufixo condizente com sua função (ex: Message, Controller, Request).
     * * MOTIVO: Evitar ambiguidade técnica e impedir que objetos de transferência (DTOs/Mensagens) sejam confundidos com o Domínio ou Casos de Uso.
     */
    @ArchTest
